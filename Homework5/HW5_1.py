...
def letter_stat(our_str):
    """
Создаем словарь из строки, где ключ - символ строки, а значение - число повторений в строке
:param our_str: строка которую преобразует в словарь
    """
    letters_dict = {}
    for i in our_str:
        letters_dict[i] = letters_dict.setdefault(i, 0) + 1
    return letters_dict
