...
def everything_for_your_cat(cats_data):
    """
Структурируем информацию о покупателях и их питомцах.
Функция возвразает фамилию и имя покупателя, имя и возраст его питомцев
    :param cats_data: картеж из данных о кошках и их владельцах
    """
    dict_cat = {}
